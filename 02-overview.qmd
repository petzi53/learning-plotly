...
: Show `r glossary("JSONx", "JSON")` object
::::::
:::
::::{.my-r-code-container}
```{r}
...
```
::: {.callout-warning #wrn-plotly-toWebGL-needs-library-ploty}
###### I do not know why the `toWebGL()` function needs `library(plotly)`
:::
...
::: {.callout-warning #wrn-02-ggally-destroys-previous-plotly-graphs}
###### The GGally code chunk destroys previous plotly graphs

I do not know why but it turned out that the above @fig-02-ggally-ggcoef destroys previous {**plotly**} graphics. Until I know what happened I have stopped the evaluation of the above code chunk.
:::
